...
# наверно это лучше убрать, нельзя добавлять новые, можно только фиксить существующие
...
# то есть если хотим добавить слово -> оно должно появиться в тексте и тогда оно появиться в словаре
# НО ЛУЧШЕ РЕШАЙ САМ, ВДРУГ ОН ДОЕБЕТСЯ
